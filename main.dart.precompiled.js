...
["chrome.app", "package:chrome/gen/app.dart", , X, {
  "^": "",
  _createLaunchData: [function(jsProxy) {
    return jsProxy == null ? null : new X.LaunchData(jsProxy);
  }, "call$1", "_createLaunchData$closure", 2, 0, 10],
  ChromeApp: {
  ...
  ChromeAppRuntime: {
    ...
    ChromeAppRuntime$_$0: function() {
      var getApi = new X.ChromeAppRuntime$__closure(this);
      this._onLaunched = G.ChromeStreamController$oneArg(getApi, "onLaunched", X._createLaunchData$closure(), null, X.LaunchData);
      this._onRestarted = G.ChromeStreamController$noArgs(getApi, "onRestarted", null);
    },
    static: {ChromeAppRuntime$_: function() {
        var t1 = new X.ChromeAppRuntime(null, null);
  ...
  _ChromeAppWindow: {
    ...
    current$0: function() {
      ...
      return t1 == null ? null : new X.AppWindow(P.LinkedHashMap_LinkedHashMap$_empty(null, null), null, t1);
    },
    ...
    _app0$_ChromeAppWindow$_$0: function() {
      var getApi = new X._ChromeAppWindow$__closure(this);
      this._onBoundsChanged = G.ChromeStreamController$noArgs(getApi, "onBoundsChanged", null);
      this._onClosed = G.ChromeStreamController$noArgs(getApi, "onClosed", null);
      this._onFullscreened = G.ChromeStreamController$noArgs(getApi, "onFullscreened", null);
      this._onMaximized = G.ChromeStreamController$noArgs(getApi, "onMaximized", null);
      this._onMinimized = G.ChromeStreamController$noArgs(getApi, "onMinimized", null);
      this._onRestored = G.ChromeStreamController$noArgs(getApi, "onRestored", null);
    }
  },
...
["chrome.src.common", "package:chrome/src/common.dart", , G, {
  "^": "",
  jsify: [function(obj) {
    var t1, m, t2, key;
    if (obj == null || typeof obj === "number" || typeof obj === "string")
      ...
      if (!!t1.$isChromeObject)
        ...
        for (t2 = obj.get$keys(), t2 = t2.get$iterator(t2); t2.moveNext$0();) {
          key = t2.get$current();
          m.$indexSet(0, key, G.jsify(t1.$index(obj, key)));
        }
        return P._wrapToDart(P.JsObject__convertDataTree(m));
      } else if (!!t1.$isIterable) {
        t2 = [];
        C.JSArray_methods.addAll$1(t2, t1.map$1(obj, G.jsify$closure()).map$1(0, P._convertToJS$closure()));
        t2 = new P.JsArray(t2);
  ...
  }, "call$1", "jsify$closure", 2, 0, 11, 12],
  ChromeStreamController: {
    ...
    }, "call$0", "get$_ensureHandlerAdded", 0, 0, 14],
    ...
    }, "call$0", "get$_removeHandler", 0, 0, 14],
    ChromeStreamController$oneArg$4: function(_apiProvider, _eventName, transformer, returnVal, $T) {
      ...
      this._listener = new G.ChromeStreamController$oneArg_closure(this, transformer, returnVal);
    },
    ChromeStreamController$noArgs$2: function(_apiProvider, _eventName, $T) {
      var t1 = this.get$_ensureHandlerAdded();
      this._controller = P.StreamController_StreamController$broadcast(this.get$_removeHandler(), t1, false, $T);
      this._listener = new G.ChromeStreamController$noArgs_closure(this);
    },
    static: {ChromeStreamController$noArgs: function(_apiProvider, _eventName, $T) {
        var t1 = H.setRuntimeTypeInfo(new G.ChromeStreamController(_apiProvider, _eventName, P.StreamController_StreamController$broadcast(null, null, false, $T), false, null), [$T]);
  ...
  ChromeStreamController$oneArg_closure: {
    "^": "Closure:40;this_0,transformer_1,returnVal_2",
    ...
    }, "call$0", "call$1", null, null, 0, 2, null, 18, 6, "call"],
    $isFunction: true
  }
}],
["chrome.src.common_exp", "package:chrome/src/common_exp.dart", , U, {
  "^": "",
  ChromeObject: {
    "^": "Object;",
    toString$0: function(_) {
...
["dart.async", "dart:async", , P, {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 48, 19, 20],
...
["dart.js", "dart:js", , P, {
  ...
  }, "call$1", "_convertToJS$closure", 2, 0, 11, 31],
  ...
  }, "call$1", "_convertToDart$closure", 2, 0, 32, 31],
  ...
  JsObject__convertDataTree__convert: {
    "^": "Closure:11;_convertedObjects_0",
    call$1: [function(o) {
...
["", "file:///F6DD7EC53B39474CEFE6A61F7E35DBBE:Spark-dart_chrome_app/web/main.dart", , D, {
  "^": "",
  main: [function() {
    var t1 = J.get$onClick$x(document.querySelector("#text_id"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(D.resizeWindow$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 14],
  resizeWindow: [function($event) {
    var t1, t2, bounds, t3;
    t1 = $.get$app().window;
    t2 = t1.current$0().jsProxy.callMethod$1("getBounds");
    bounds = t2 == null ? null : new X.ContentBounds(t2);
    t2 = bounds.jsProxy;
    t3 = J.getInterceptor$asx(t2);
    t3.$indexSet(t2, "width", J.$add$ns(t3.$index(t2, "width"), $.boundsChange));
    t3.$indexSet(t2, "left", J.$sub$n(t3.$index(t2, "left"), C.JSInt_methods._tdivFast$1($.boundsChange, 2)));
    t1.current$0().jsProxy.callMethod$2("setBounds", [G.jsify(bounds)]);
    $.boundsChange = $.boundsChange * -1;
    t1 = document.querySelector("#count");
    t2 = $.count;
    $.count = t2 + 1;
    t1.textContent = C.JSInt_methods.toString$0(t2);
  }, "call$1", "resizeWindow$closure", 2, 0, 33, 34]
},
1],
]);
...
Isolate.$lazy($, "app", "app", "get$app", function() {
  var t1, t2;
  t1 = X.ChromeAppRuntime$_();
  t2 = new X.ChromeAppWindow(null, null, null, null, null, null);
  t2._app0$_ChromeAppWindow$_$0();
  return new X.ChromeApp(t1, t2);
});
...
"arg3",
"arg4",
{func: "LaunchData__JsObject", ret: X.LaunchData, args: [P.JsObject]},
...
function dart_precompiled($collectedClasses) {
  ...
  function ContentBounds(jsProxy) {
    this.jsProxy = jsProxy;
  }
  ContentBounds.builtin$cls = "ContentBounds";
  if (!"name" in ContentBounds)
    ContentBounds.name = "ContentBounds";
  $desc = $collectedClasses.ContentBounds;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ContentBounds.prototype = $desc;
  function _AppWindow() {
  }
